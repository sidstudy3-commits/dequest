...
import { Flame, LogIn, Mail, Lock, Loader2 } from 'lucide-react';
      ...
      <div className="w-full max-w-md glass-panel p-8 relative z-10 border-glassBorder/40">
        <div className="flex flex-col items-center gap-3 text-center mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">Sign in to resume your DevQuest journey</p>
          </div>
        </div>
        ...
        <p className="text-xs text-center text-gray-400 mt-6">
          ...
          <Link to="/register" className="text-neonPurple hover:text-neonPurple/80 font-bold transition-all">
            Create Account
          </Link>
        </p>
      </div>
